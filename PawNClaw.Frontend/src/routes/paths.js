...
export const PATH_DASHBOARD = {
  ...
  bookingDetail: {
    root: path(ROOTS_DASHBOARD, '/booking-detail'),
    bookingList: (id) => path(ROOTS_DASHBOARD, `/list/booking-detail/${id}`),
    bookingCalendar: (id) => path(ROOTS_DASHBOARD, `/calendar/booking-detail/${id}`),
  },
  brand: {
