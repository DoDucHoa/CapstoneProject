...
export default function CageTypeDetail() {
  return (
    <Grid container spacing={3}>
      ...
      <Grid item xs={12} sm={4}>
        <RHFTextField name="createCageTypeParameter.height" label="Chiều cao (cm)" type="number" />
      </Grid>
      <Grid item xs={12} sm={4}>
        <RHFTextField name="createCageTypeParameter.width" label="Chiều rộng (cm)" type="number" />
      </Grid>
      <Grid item xs={12} sm={4}>
        <RHFTextField name="createCageTypeParameter.length" label="Chiều dài (cm)" type="number" />
      </Grid>
      <Grid item xs={12} sm={4}>
