...
import 'package:pawnclaw_mobile_application/screens/search_screen.dart/components/choose_pet_card.dart';
          ...
          onPressed: () {
            ...
            BlocProvider.of<BookingBloc>(context).add(
              SelectSupply(
                  sellPrice: supply.sellPrice!,
                  supplyId: supply.id!,
                  petId:  pets[selectedIndex].id!)//: (state as BookingUpdated).selectedPet!.id!),
            );
